...
export const curatedMedia: MediaItem[] = [
  ...
  {
    number: 14,
    title: "Whynot TV: Tianqi Chen",
    host: "YouTube",
    addedDate: "2026-07-07",
    description: "陈天奇谈初心、理想主义，以及 XGBoost、MXNet、TVM、MLC 背后的机器学习系统之路。",
    note: "Machine learning systems, open source, and long-term idealism.",
    youtubeUrl: "https://www.youtube.com/watch?v=jvqsvbntEFQ",
    tags: ["selected", "ai", "systems", "open-source", "podcast"],
    category: "Podcast",
    featured: false,
  },
  {
    number: 15,
    title: "Lin vs. Li | 2017 All England Open Final",
    host: "YouTube",
    addedDate: "2026-07-07",
    description: "Lin Dan and Lee Chong Wei meet in the 2017 All England Open final.",
    note: "Badminton classic, All England final, Lin Dan vs. Lee Chong Wei.",
    youtubeUrl: "https://www.youtube.com/watch?v=DDG8RvCUwVc",
    tags: ["selected", "badminton", "lin-dan", "lee-chong-wei"],
    category: "Badminton",
    featured: true,
  },
];
